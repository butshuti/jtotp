...
/**
 * This class implements the Time-based One-Time Passwords (TOTP) algorithm (RFC6238).
 * Codes generated by instances of this class are 8 characters long.
 * The default window/skew for the generated codes is 30 seconds.
 */
public class TOTP {
    ...
    /**
     * Create an instance using a given HMAC mode (availability depends on JDK and crypto engine).
     * @param mode
    ...
    /**
     * Create an instance using the default HMAC mode (HMACSHA1).
     * @throws NoSuchAlgorithmException
     */
    ...
    /**
     * Generate a list of TOTP codes that are valid in the current time window using a given secret.
     * <p>The default window is 30 seconds</p>
    ...
    /**
     * Generate a TOTP code using a given secret.
     * @param secret The secret
     * @return A TOTP code
     * @throws GeneralSecurityException
     * @throws InvalidCodeFormatException
    ...
    /**
     * Verify a TOTP code using a given secret.
     * @param secret The secret
